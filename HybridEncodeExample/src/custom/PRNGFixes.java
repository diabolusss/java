...
public final class PRNGFixes {
   ...
   private static void applyOpenSSLFix() throws SecurityException {
       ...
       try {
           ...
           if (ALLOW_BROKEN_PRNG) {
               System.out.println(PRNGFixes.class.getSimpleName()+ "Failed to seed OpenSSL PRNG#"+ e);
           } else {
   ...
   private static void installLinuxPRNGSecureRandom() throws SecurityException {
       ...
       synchronized (java.security.Security.class) {
           ...
           if (!rng1.getProvider().getClass().getSimpleName().equals("LinuxPRNGSecureRandomProvider")) {
               if (ALLOW_BROKEN_PRNG) {
                   System.out.println(PRNGFixes.class.getSimpleName()+
           ...
           try {
               ...
               if (ALLOW_BROKEN_PRNG) {
                   System.out.println(PRNGFixes.class.getSimpleName()+ "SHA1PRNG not available"+ e);
                   return;
               } else {
   ...
   public static class LinuxPRNGSecureRandom extends SecureRandomSpi {
       ...
       protected void engineSetSeed(byte[] bytes) {
           try {
               ...
               System.out.println(PRNGFixes.class.getSimpleName()+ "Failed to mix seed into "
                       + URANDOM_FILE);
           } finally {
               mSeeded = true;
           }
   ...
   private static byte[] getBuildFingerprintAndDeviceSerial() {
       ...
       String fingerprint = "asdasd";//Build.FINGERPRINT;
       if (fingerprint != null) {
